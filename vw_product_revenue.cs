...
{
    public partial class vw_product_revenue : Form
    {
        private readonly GridSortState _sortState = new GridSortState();

        public vw_product_revenue()
        {
            InitializeComponent();
            dataGridView1.ColumnHeaderMouseClick += dataGridView1_ColumnHeaderMouseClick;
        }

        private void vw_product_revenue_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "shopDataSet.vw_product_revenue". При необходимости она может быть перемещена или удалена.
            vw_product_revenueTableAdapter.Fill(shopDataSet.vw_product_revenue);
        ...
        private void dataGridView1_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            vwproductrevenueBindingSource.Sort = $"{dataPropertyName} {sortDirectionText}";
        ...
        {
            DataTable sourceTable = shopDataSet.vw_product_revenue;
            if (sourceTable == null)
            {
                return;
            }
            ...
            using (FilterDialog dialog = new FilterDialog(GetFilterColumns(sourceTable)))
            {
                ...
                try
                {
                    ...
                    vwproductrevenueBindingSource.DataSource = filtered;
                }
        ...
        {
            vwproductrevenueBindingSource.DataSource = shopDataSet.vw_product_revenue;
            vwproductrevenueBindingSource.RemoveFilter();
            vwproductrevenueBindingSource.Sort = string.Empty;
