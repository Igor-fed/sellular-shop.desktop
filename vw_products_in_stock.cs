...
{
    public partial class vw_products_in_stock : Form
    {
        private readonly GridSortState _sortState = new GridSortState();

        public vw_products_in_stock()
        {
            InitializeComponent();
            dataGridView1.ColumnHeaderMouseClick += dataGridView1_ColumnHeaderMouseClick;
        }

        private void vw_products_in_stock_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "shopDataSet.vw_products_in_stock". При необходимости она может быть перемещена или удалена.
            vw_products_in_stockTableAdapter.Fill(shopDataSet.vw_products_in_stock);
        ...
        private void dataGridView1_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            vwproductsinstockBindingSource.Sort = $"{dataPropertyName} {sortDirectionText}";
        ...
        {
            DataTable sourceTable = shopDataSet.vw_products_in_stock;
            if (sourceTable == null)
            {
                return;
            }
            ...
            using (FilterDialog dialog = new FilterDialog(GetFilterColumns(sourceTable)))
            {
                ...
                try
                {
                    ...
                    vwproductsinstockBindingSource.DataSource = filtered;
                }
        ...
        {
            vwproductsinstockBindingSource.DataSource = shopDataSet.vw_products_in_stock;
            vwproductsinstockBindingSource.RemoveFilter();
            vwproductsinstockBindingSource.Sort = string.Empty;
