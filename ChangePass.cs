...
{
    public partial class btnChangePass : Form
    {
        public btnChangePass()
        {
            InitializeComponent();
        }
        ...
        private void UpdatePassword(string password)
        {
            ...
            ShowStatus($"Пароль обновлен для {employee.login}. Новый пароль {password}", MessageBoxIcon.Information);
        }
