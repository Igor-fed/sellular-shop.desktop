...
{
    public partial class vw_sales_products : Form
    {
        private readonly GridSortState _sortState = new GridSortState();

        public vw_sales_products()
        {
            InitializeComponent();
        ...
        private void dataGridView1_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            vwsalesproductsBindingSource.Sort = $"{dataPropertyName} {sortDirectionText}";
        ...
        private void filter_Click(object sender, EventArgs e)
        {
            ...
            using (FilterDialog dialog = new FilterDialog(GetFilterColumns(sourceTable)))
            {
                ...
                try
                {
                    ...
                    vwsalesproductsBindingSource.DataSource = filtered;
                }
